## Cora Z7-07S Rev. B
## Pure-PL I2S audio_fx stage
## Top-level entity: audio_fx
##
## Active ports in audio_fx.vhd:
##   clock : in  std_logic
...
## Buttons
set_property -dict { PACKAGE_PIN D20 IOSTANDARD LVCMOS33 } [get_ports {btn_up}]
set_property -dict { PACKAGE_PIN D19 IOSTANDARD LVCMOS33 } [get_ports {btn_down}]