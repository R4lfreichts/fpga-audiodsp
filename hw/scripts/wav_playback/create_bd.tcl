...
################################################################
# This is a generated script based on design: audio_dma_bd
#
...
# source audio_dma_bd_script.tcl
...
proc create_root_design { parentCell } {
  ...
  set buttons_0 [ create_bd_port -dir I -from 1 -to 0 buttons_0 ]
  ...
  set underrun_0 [ create_bd_port -dir O underrun_0 ]
...
\
  ...
  # Create instance: i2s_audio_sink_0, and set properties
  set block_name i2s_audio_sink
  set block_cell_name i2s_audio_sink_0
  if { [catch {set i2s_audio_sink_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $i2s_audio_sink_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins axis_data_fifo_0/M_AXIS] [get_bd_intf_pins i2s_audio_sink_0/s_axis]
  ...
  connect_bd_net -net buttons_0_1 [get_bd_ports buttons_0] [get_bd_pins axi_gpio_0/gpio_io_i]
  connect_bd_net -net clock_0_1 [get_bd_ports clock_0] [get_bd_pins i2s_audio_sink_0/clock]
  connect_bd_net -net i2s_audio_sink_0_audio_clk_out [get_bd_pins i2s_audio_sink_0/audio_clk_out] [get_bd_pins axis_data_fifo_0/m_axis_aclk]
  connect_bd_net -net i2s_audio_sink_0_audio_resetn_out [get_bd_pins i2s_audio_sink_0/audio_resetn_out] [get_bd_pins axis_data_fifo_0/m_axis_aresetn]
  connect_bd_net -net i2s_audio_sink_0_mclk [get_bd_pins i2s_audio_sink_0/mclk] [get_bd_ports mclk_0]
  connect_bd_net -net i2s_audio_sink_0_sclk [get_bd_pins i2s_audio_sink_0/sclk] [get_bd_ports sclk_0]
  connect_bd_net -net i2s_audio_sink_0_sd_tx [get_bd_pins i2s_audio_sink_0/sd_tx] [get_bd_ports sd_tx_0]
  connect_bd_net -net i2s_audio_sink_0_underrun [get_bd_pins i2s_audio_sink_0/underrun] [get_bd_ports underrun_0]
  connect_bd_net -net i2s_audio_sink_0_ws [get_bd_pins i2s_audio_sink_0/ws] [get_bd_ports ws_0]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn]
  connect_bd_net -net sd_rx_0_1 [get_bd_ports sd_rx_0] [get_bd_pins i2s_audio_sink_0/sd_rx]
